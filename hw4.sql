...
-- 1
SELECT MARK,COLOR,COUNT(*) AS ColorCount
FROM auto
...
-- 2
SELECT DISTINCT MARK, COUNT(*) AS ThisAutoCount, (SELECT COUNT(*)
FROM auto OthersAuto
WHERE OthersAuto.MARK != ThisAuto.MARK) AS OthersCount
FROM auto ThisAuto
GROUP BY MARK;
